...
function PocketSettingsTab({ rpcCall, t }) {
  ...
  return h('div', { style: styles.card },
    ...
    h('div', { style: styles.block },
      ...
      h('details', { style: { marginTop: 6, padding: '8px 10px', borderRadius: 8, border: '1px solid rgba(220,38,38,.25)', background: 'rgba(220,38,38,.035)', color: 'var(--dsw-alias-state-error-primary,#b91c1c)', fontSize: 12, lineHeight: 1.55 } },
        h('summary', { style: { cursor: 'pointer', fontWeight: 600 } }, t('guestSecurityLimitTitle')),
        h('div', { style: { marginTop: 7, color: 'var(--dsw-alias-label-secondary,#4b5563)' } }, t('guestSecurityLimitBody')),
      ),
